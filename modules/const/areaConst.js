const areaConst = {
    ...
    meng : ['兴安盟','锡林郭勒盟','阿拉善盟'],
    //地区
    diQu : ['大兴安岭地区', '阿里地区', '阿克苏地区', '喀什地区', '和田地区', '塔城地区', '阿勒泰地区'],
    //自治州
    ziZhiZhou : ['延边朝鲜族自治州', '恩施土家族苗族自治州', '湘西土家族苗族自治州', '阿坝藏族羌族自治州', '甘孜藏族自治州', '凉山彝族自治州', 
    ...
    //自治州简称
    ziZhiZhouSN : ['延边', '恩施', '湘西', '阿坝', '甘孜', '凉山', '黔西南', '黔东南', '黔南', '楚雄', '红河', '文山', '西双版纳', '大理', 
    '德宏', '怒江', '迪庆', '临夏', '甘南', '海北', '黄南', '海南', '果洛', '玉树', '海西', '昌吉', '博尔塔拉', '巴音郭楞', '克孜勒', '伊犁'],
    //自治县
    ziZhiXian : ['青龙满族自治县', '丰宁满族自治县', '宽城满族自治县', '围场满族蒙古族自治县', '孟村回族自治县', '大厂回族自治县', 
    ...
    //自治县简称
    ziZhiXianSN : ['青龙', '丰宁', '宽城', '围场', '孟村', '大厂', '岫岩', '新宾', '清原', '本溪', '桓仁', '宽甸', '阜新', '喀喇沁左翼', 
    ...
    //新区、管理区
    xinQu : ['滨海新区', '井陉矿区', '峰峰矿区', '沈北新区', '浦东新区', '镇江高新区', '兰州新区', '鹰手营子矿区', '白云鄂博矿区', '神农架林区',
    ...
    //新区简称
    xinQuSN :  ['滨海新区', '井陉', '峰峰', '沈北新区', '浦东新区', '镇江高新区', '兰州新区', '鹰手营子', '白云鄂博', '神农架', '新城区',
    '大通湖区', '北戴河新区', '冀南新区', '渤海新区', '滨湖新区', '白沟新城', '汉沽', '察北', '塞北', '龙感湖',
    '屈原', '西洞庭', '大通湖', '金洞', '回龙圩', '洪江'],
    gaoXinQu : ['山西转型综合改革示范区', '新乡市平原城乡一体化示范区', '焦作城乡一体化示范区', '南阳市城乡一体化示范区', '云龙示范区', 
